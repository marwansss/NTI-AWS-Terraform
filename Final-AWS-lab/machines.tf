...
resource "aws_lb" "web-lb" {
  ...
  #subnets            = [aws_subnet.private-subnet1.id, aws_subnet.private-subnet2.id, aws_subnet.private-subnet3.id, aws_subnet.public-subnet1.id, aws_subnet.public-subnet2.id]
}
